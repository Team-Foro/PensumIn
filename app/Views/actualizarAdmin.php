...
<form class="longin" method="post" action="<?php echo base_url() ?>/admin/editar" >
    <h2> Datos del Usuario</h2>

    <input type="hidden" name="id" id="id" value="<?php echo $id ?>">
    <input type="text" name="usuario" minlength="7" maxlength="20" placeholder="Usuario" value ="<?php echo $usuario ?>" required>
    ...
    <label <?php if ($rol == 3) { echo 'hidden="true"'; } ?>> Rol </label>

    <select name="rol" <?php if ($rol == 3) { echo 'hidden="true"'; } ?> required>
        <option value="1" <?php if ($rol == '1') { echo "selected"; } ?>> Administrador </option>
        <option value="2" <?php if ($rol == '2') { echo "selected"; } ?>> Operador </option>
        <option value="3" <?php if ($rol == '3') { echo "selected"; } else { echo 'hidden="true"';} ?>> Estudiante </option>
    </select>
