...
<nav class="navbar navbar-expand-lg bg-light">
    <div class="container-fluid">
        <a class="navbar-brand" href="<?php echo base_url().'/admin' ?>"> <?php echo session()->get('datosUsuario')['usuario'] ?> </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <a class="nav-link" href="<?php echo base_url().'/admin/editar/'.session()->get('datosUsuario')['id'] ?>"> Editar </a>
